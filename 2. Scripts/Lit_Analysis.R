...
box(bty = 'l')
mtext(text = "No. of Papers",side = 2, line = 2.9, cex =1)
...
mtext(text = 'b)',adj = 1, at = -2.8, line = 0,cex = 0.95)
...
box(bty='l')
mtext(text = "No. of Papers",side = 2, line = 2.8, cex =1)
...
mtext(as.expression(bquote(chi^2~"= 300.46")),adj = 1,at = 11,line = -1.7,cex = 0.9)
mtext(text = expression(italic('p')< 0.001),adj = 1,at = 11,line = -2.5,cex=0.9)
mtext(text = 'a)',at = -4.5,line = -0.1,cex =0.95)

par(mar = c(9,4,1,1))
barplot(Tax_Chi1[order(Tax_Chi1, decreasing = T)],las = 2,names.arg = c('Taxon',"Functional Group"))
box(bty='l')
mtext(text = "No. of Papers",side = 2, line = 2.8, cex =1, at = 100)
...
par(mar = c(9,4,1,1))
barplot(TaxPHY_Chi[order(TaxPHY_Chi,decreasing = T)],las = 2,names.arg = c('Hymenoptera',"Coleoptera",'Diptera','Lepidoptera','Other','Hemiptera','Arachnida'))
box(bty='l')
mtext(text = "No. of Papers",side = 2, line = 2.4, cex =1, at = 50)
...
mtext(text = 'c)',at = -3,line = -0.1,cex =0.95)

par(mar = c(9,4,1,1))
barplot(TaxFUN_Chi[order(TaxFUN_Chi, decreasing = T)],las = 2,names.arg = c('Plant Dwelling',"Surface Active",'Flying','Endogeic'))
box(bty='l')
mtext(text = "No. of Papers",side = 2, line = 2.4, cex =1, at = 17)
mtext(text = 'df = 3',adj = 1,at = 5,line = 0.1,cex=0.9)
